...
public class VentureChatEvent extends Event {
	...
	private final IVentureChatPlayer ventureChatPlayer;
	...
	public VentureChatEvent(final IVentureChatPlayer ventureChatPlayer, final String username, final String playerPrimaryGroup, final IChatChannel channel,
