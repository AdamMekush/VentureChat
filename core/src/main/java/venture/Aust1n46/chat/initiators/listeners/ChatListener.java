...
import venture.Aust1n46.chat.model.IMuteContainer;
...
public class ChatListener implements Listener {
	...
	private void processMute(final IVentureChatPlayer ventureChatPlayer, final IChatChannel channel) {
	...
	private void handleVentureChatEvent(VentureChatEvent event) {
		IVentureChatPlayer ventureChatPlayer = event.getVentureChatPlayer();
